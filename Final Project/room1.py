...
face_cascade = cv2.CascadeClassifier('haar_cascade_files/haarcascade_frontalface_defalt.xml')
...
if len(pickle_files) == 0:
	print("No face data in the 'faces' directore. Please populate the directory with valid pickle files")
	exit()
